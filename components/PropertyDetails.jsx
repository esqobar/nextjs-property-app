import {FaBath, FaBed, FaMapMarker, FaRulerCombined, FaTimes, FaCheck} from "react-icons/fa";
        ...
        <main>
            ...
            >
                ...
                <div className="flex flex-col md:flex-row justify-around">
                    ...
                    <div
                        className="flex items-center justify-center mb-4 border-b border-gray-200
                         md:border-b-0 pb-4 md:pb-0"
                    >
